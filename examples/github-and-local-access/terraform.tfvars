...
project_name     = "my-terraform-project"  # Change to your project name
...
github_repo        = "your-github-repo"     # Replace with your GitHub repository
github_branches    = ["main", "develop"]    # Branches allowed to deploy

# Local Development Access
# Add your AWS user ARN here to allow assumption from your local machine
trusted_aws_principals = [
  "arn:aws:iam::123456789012:user/your-username"  # Replace with your AWS user ARN
]

# Session Configuration
session_duration = 3600  # 1 hour (adjust as needed)
